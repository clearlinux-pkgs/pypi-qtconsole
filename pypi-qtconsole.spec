...
Provides: qtconsole
Provides: qtconsole-python
Provides: qtconsole-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641487614
...
cp %{_builddir}/qtconsole-5.2.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
