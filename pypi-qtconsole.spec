...
Version  : 5.4.0
Release  : 82
URL      : https://files.pythonhosted.org/packages/49/c6/345fffb3f6d8c9607deac4d5ff86e7ad9baf46171267585f5da10b3db890/qtconsole-5.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/49/c6/345fffb3f6d8c9607deac4d5ff86e7ad9baf46171267585f5da10b3db890/qtconsole-5.4.0.tar.gz
...
%prep
%setup -q -n qtconsole-5.4.0
cd %{_builddir}/qtconsole-5.4.0
pushd ..
cp -a qtconsole-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667399907
