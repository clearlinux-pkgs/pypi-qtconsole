...
%prep
%setup -q -n qtconsole-5.3.1
cd %{_builddir}/qtconsole-5.3.1
pushd ..
cp -a qtconsole-5.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528733
...
cp %{_builddir}/qtconsole-5.3.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-qtconsole/6b85326e6a68c099bbfa0e2c7d5ca15aa9763753
